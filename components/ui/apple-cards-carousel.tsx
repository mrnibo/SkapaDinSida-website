  ...
  return (
    ...
    >
      <div className="relative w-full">
        ...
        {/* Slider */}
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto py-2 md:py-5 scroll-smooth [scrollbar-width:none]"
          ref={carouselRef}
      ...
      <LinkPreview url={link} className="">
        ...
        >
          ...
          <div className="relative z-40 p-8">
            ...
            >
              <Badge className="bg-neutral-900">{card.category}</Badge>
            </motion.div>
            <motion.p
              layoutId={layout ? `title-${card.title}` : undefined}
